...
export default function AlterarConta() {
    ...
    const alterarConta = async () => {
        ...
        try {
            ...
            if (resp.erro) {
                ...
                localStorage.setItem('usuario-logado', JSON.stringify(usuarioAtualizado));
    ...
    // Nova função para abrir o modal de redefinição de senha
    const abrirModalResetSenha = () => {
        setShowResetModal(true);
    }

    // Nova função para fechar o modal de redefinição de senha
    ...
    // Nova função para processar a redefinição de senha
    const processarResetSenha = async () => {
        ...
        try {
            ...
            if (resp.erro) {
                ...
                setTimeout(() => {
                    toast.info('Você precisará usar sua nova senha ao fazer login novamente');
                }, 1000);
                    ...
                    <div className="form-row">
                        ...
                        <div className="button-container" style={{ display: 'flex', gap: '10px' }}>
                            <ChatButtonAlterar
                                ...
                                style={{ fontSize: '1.2em'}}> Alterar </ChatButtonAlterar>
                            <ChatButtonAlterar
                                onClick={voltarAoChat}
                                style={{ fontSize: '1.2em', backgroundColor: '#666' }}> Voltar </ChatButtonAlterar>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div className="reset-password-modal">
                    <div className="reset-password-content">
                        <div className="reset-password-header">
                            ...
                            <button className="reset-password-close" onClick={fecharModalResetSenha}>×</button>
                        </div>
